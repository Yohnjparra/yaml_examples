...
\urlstyle{same}
\hypersetup{
  pdftitle={Yaml\_examples},
  pdfauthor={Yohn Jairo Parra Bautista, PhD.},
  hidelinks,
...
\pandocbounded{\includegraphics[keepaspectratio]{yamlExamples_files/figure-latex/pressure-1.pdf}}
